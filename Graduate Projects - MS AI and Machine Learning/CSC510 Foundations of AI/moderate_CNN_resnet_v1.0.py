...
transform = transforms.Compose([
    transforms.Resize((224, 224)),  # ResNet18 requires 224x224 input
...
model.fc = nn.Linear(num_ftrs, len(class_mapping))  # Replace last layer with our classes
model = model.to(device)

# Define Loss Function & Optimizer
criterion = nn.CrossEntropyLoss()
optimizer = optim.Adam(model.parameters(), lr=0.0001)  # Smaller LR for transfer learning
