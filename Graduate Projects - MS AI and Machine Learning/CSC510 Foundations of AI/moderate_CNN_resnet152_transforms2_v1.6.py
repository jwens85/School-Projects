...
transform = transforms.Compose([
    ...
    transforms.RandomVerticalFlip(p=0.2),  # Flip vertically 20% of the time
    transforms.RandomAffine(degrees=20, translate=(0.2, 0.2), scale=(0.8, 1.2), shear=15),  # More variations
...
torch.save(model.state_dict(), "resnet152_vehicle_damage_transforms.pth")
