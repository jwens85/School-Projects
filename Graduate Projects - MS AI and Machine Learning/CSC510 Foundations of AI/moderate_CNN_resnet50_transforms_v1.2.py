...
model = models.resnet50(weights=ResNet50_Weights.DEFAULT)  # Load ResNet50
...
optimizer = optim.Adam(model.parameters(), lr=0.00005)  # Smaller LR for better fine-tuning
...
torch.save(model.state_dict(), "resnet50_vehicle_damage_finetuned.pth")
