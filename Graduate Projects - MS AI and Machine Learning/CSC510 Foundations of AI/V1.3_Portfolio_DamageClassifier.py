...
# Fix class mapping issue (swap keys & values)
class_mapping = {v: k for k, v in class_mapping.items()}  # Correct the mapping
print("Corrected class mapping:", class_mapping)
...
def predict_damage(image_path):
    ...
    with torch.no_grad():
        ...
        damage_type = class_mapping[predicted.item()]  # Fixed KeyError issue
