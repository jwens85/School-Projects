...
# **Reverting Back to Original Data Augmentation**
...
for param in model.layer2.parameters():  #Unfreeze `layer2` (keeping layer1 frozen)
...
optimizer = optim.Adam(model.parameters(), lr=0.00003)  #Lower initial LR
...
for epoch in range(num_epochs):
    ...
    scheduler.step(accuracy)  #Adjust LR dynamically when accuracy stalls
...
# **Save Final Model**
torch.save(model.state_dict(), "resnet152_vehicle_damage_unfreeze.pth")
