...
# **Unfreeze Selected Layers (`layer2`, `layer3`, `layer4`)**
...
for epoch in range(num_epochs):
    ...
    print(f"Epoch {epoch+1}: Loss = {running_loss:.4f}, Validation Accuracy = {accuracy:.2f}%, Learning Rate = {new_lr:.8f}")

    # **Save best model based on accuracy AND loss**
    if accuracy > best_accuracy or (accuracy >= best_accuracy - 0.5 and running_loss < best_loss):
