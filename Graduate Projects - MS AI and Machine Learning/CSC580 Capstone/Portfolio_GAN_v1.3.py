...
script_name = os.path.basename(__file__)  # Gets "Portfolio_GAN_v1.3.py"
version_part = script_name.split('_')[2].split('.py')[0]  # Gets "v1.3"
...
# Save final models using modern .keras format
generator.save(os.path.join(base_output_dir, "generator_trained.keras"))
encoder.save(os.path.join(base_output_dir, "encoder_trained.keras"))
