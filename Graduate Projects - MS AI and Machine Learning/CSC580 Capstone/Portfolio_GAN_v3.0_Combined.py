...
script_name = os.path.basename(__file__)  # Gets "Portfolio_GAN_v3.0_Full_Training.py"
version = script_name.split('_')[2].split('.')[0]  # Extracts "v3"
if "full" in script_name.lower():
    version += "_full_gan"
...
print(f"GAN v3.0 - Full Adversarial Training")
...
plt.suptitle('GAN Training Progress: First vs Last Epoch', fontsize=16)
plt.tight_layout()
