...
# V5.1 FRESH START: Skip all pre-trained weight loading to test balanced training theory
print("V5.1: Starting both Generator and Critic training from scratch")
print("Testing hypothesis: Pre-trained generator + fresh critic = mode collapse")
print("Both networks will learn together from random initialization")

# WGAN-GP learning rates
CRITIC_LR = 0.0001
GENERATOR_LR = 0.0001

print(f"\n{version} WGAN-GP v5.1 Fresh Start Configuration:")
...
print(f"- Both networks start from random initialization")
...
print(f"\n{version} v5.1 Fresh Start Improvements:")
print(f"- No pre-trained weights loaded - balanced adversarial training")
print(f"- Both networks learn together from random initialization")
print(f"- Testing theory: Pre-trained generator + fresh critic caused mode collapse")
print(f"- Gradient penalty weight: {GRADIENT_PENALTY_WEIGHT}")
...
print(f"\nV5.1 Fresh Start Theory Test:")
print(f"- Previous runs: Pre-trained generator + fresh critic = mode collapse")
print(f"- This run: Both networks start from scratch for balanced competition")
print(f"- Hypothesis: Equal starting point will prevent early generator dominance")
print(f"- Expected: More diverse outputs, slower but stable convergence")

print(f"\nWGAN-GP v5.1 should solve mode collapse through balanced initialization!")
print(f"Ready for 8+ hour training run - let's see if the theory holds!")